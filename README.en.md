...
<p align="center">Stable version <code>v1.1.2</code> · Maintenance status: security and compatibility maintenance</p>
...
Confirm the tool version first. An output of `github-safe-publish 1.1.2` binds later reports to this stable implementation
...
The current stable version is `1.1.2`. Maintenance resumes for a critical miss, parser incompatibility, damaged report or checkpoint, or a reproducible incorrect allow or denial
