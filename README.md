...
<p align="center">稳定版本 <code>v1.1.1</code> · 维护状态：安全与兼容性维护</p>
...
先确认工具版本；命令显示 `github-safe-publish 1.1.1` 时，后续报告能够绑定到本次稳定实现
...
当前稳定版本为 `1.1.1`；维护者支持这个版本，并在关键漏检、解析器不兼容、报告损坏或可复现错误阻断与错误放行出现时恢复维护
